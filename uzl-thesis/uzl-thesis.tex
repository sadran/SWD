...
\UzLThesisSetup{
  ...
  %
  Mit Unterstützung von = {Die Arbeit ist im Rahmen einer Tätigkeit bei der Firma Gestigon GmbH entstanden.},
  % 
...
\include{chapters/background_and_related_works}
\include{chapters/swd_dataset}
\include{chapters/ground_truth_generation_circle_fitting}
\include{chapters/ground_truth_generation_aruco}
\include{chapters/model_and_methodology}
