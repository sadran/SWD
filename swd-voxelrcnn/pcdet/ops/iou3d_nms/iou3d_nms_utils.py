...
def boxes_iou3d_gpu(boxes_a, boxes_b):
    ...
    max_of_min = torch.max(boxes_a_length_min, boxes_b_length_min)
    min_of_max = torch.min(boxes_a_length_max, boxes_b_length_max)
    overlaps_l = torch.clamp(min_of_max - max_of_min, min=0)

    # 3d iou
    overlaps_3d = overlaps_bev * overlaps_l
